...
pub fn send(queue: Queue, message: Json) -> Promise(Result(Nil, Error)) {
...
pub fn ack(message: Message(a)) -> Promise(Result(Nil, Error)) {
...
pub fn retry(message: Message(a)) -> Promise(Result(Nil, Error)) {
